...
export default function SignUpForm() {
  ...
  return (
    <section className="flex items-center justify-center min-h-screen bg-gray-50 relative py-16">
      <div className="absolute top-0 left-0 w-full h-full bg-green-700 opacity-10"></div>
      <Card className="w-full max-w-md py-5 gap-1 shadow-lg z-10 rounded-2xl border-0">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <div className="flex items-center justify-center gap-1 border border-primary rounded-lg px-3 h-11 bg-gray-50 cursor-pointer min-w-22.5">
                ...
                <span className="text-sm text-gray-700 font-medium">+880</span>
